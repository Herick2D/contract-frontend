...
export default function DashboardPage() {
  ...
  return (
    <>
      <Header title="Dashboard" description="Visão geral do sistema de geração de contratos" />
      ...
      <div className="p-8">
        ...
        >
          <motion.div variants={itemVariants} className="grid grid-cols-3 gap-6">
            <Card variant="elevated" className="p-6 bg-neutral-50 dark:bg-gray-800">
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <span className="text-xs text-neutral-700 dark:text-gray-200 font-semibold uppercase tracking-wide">
                  Modelos ativos
                </span>
              </div>
            </Card>
            ...
            <Card variant="elevated" className="p-6 bg-neutral-50 dark:bg-gray-800">
              ...
              <Link
                href="/contracts"
                className="mt-4 flex items-center gap-2 text-neutral-900 dark:text-white hover:text-neutral-700 dark:hover:text-gray-300 transition-colors font-bold uppercase text-xs tracking-wide"
              >
          ...
          <motion.div variants={itemVariants}>
            <h2 className="text-lg font-bold text-neutral-900 dark:text-white mb-4 uppercase tracking-wide">
              Ações Rápidas
            </h2>
          ...
          <motion.div variants={itemVariants}>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-neutral-900 dark:text-white uppercase tracking-wide">
                Templates Recentes
              </h2>
              <Link href="/templates">
            ...
            {recentTemplates.length === 0 ? (
              <Card variant="bordered" className="p-8 text-center bg-neutral-50 dark:bg-gray-800">
                ...
                <Link href="/templates">
                  <Button variant="secondary">Adicionar Template</Button>
                </Link>
              </Card>
            ) : (
              <div className="grid grid-cols-3 gap-6">
                {recentTemplates.map((template) => (
                  <Card
                    key={template.id}
                    variant="default"
                    className="p-5 bg-neutral-50 dark:bg-gray-800"
                  >
          ...
          <motion.div variants={itemVariants}>
            <Card
              variant="default"
              className="p-6 bg-neutral-200 dark:bg-gray-800 border-2 border-neutral-400 dark:border-gray-700"
            >
              <div className="flex items-center gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-neutral-700 dark:text-gray-200 mt-2 font-medium text-sm">
                    1. Upload do template Word → 2. Upload dos prints → 3. Upload do Excel → 4.
