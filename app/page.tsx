      ...
      <div className="p-8">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-4 gap-6">
            <Card variant="elevated" className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-primary-500 font-medium">Templates</p>
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <span className="text-sm text-primary-500">Modelos ativos</span>
              </div>
            </Card>
            ...
            <Card variant="elevated" className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-primary-500 font-medium">Prints</p>
                  <p className="text-3xl font-bold text-primary-900 mt-1">
                    {stats.prints}
                  </p>
                </div>
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <span className="text-sm text-primary-500">Imagens carregadas</span>
              </div>
            </Card>
            ...
            <Card variant="elevated" className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-primary-500 font-medium">Status API</p>
                  <div className="flex items-center gap-2 mt-1">
                    {stats.apiStatus === 'loading' ? (
                      <div className="w-3 h-3 rounded-full bg-primary-300 animate-pulse" />
                    ) : stats.apiStatus === 'online' ? (
                      <div className="w-3 h-3 rounded-full bg-success-500" />
                    ) : (
                      <div className="w-3 h-3 rounded-full bg-error-500" />
                    )}
                    <span className="text-2xl font-bold text-primary-900 capitalize">
                      {stats.apiStatus}
                    </span>
                  </div>
                </div>
              ...
              <div className="mt-4 flex items-center gap-2">
                ...
                <span className="text-sm text-primary-500">localhost:8000</span>
              </div>
            </Card>
            ...
            <Card variant="elevated" className="p-6">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-primary-500 font-medium">Pronto para</p>
              ...
              <Link href="/contracts" className="mt-4 flex items-center gap-2 text-accent-600 hover:text-accent-700 transition-colors">
          ...
          <motion.div variants={itemVariants}>
            <h2 className="text-lg font-semibold text-primary-900 mb-4">Ações Rápidas</h2>
              ...
              {quickActions.map((action, index) => (
                <Link key={action.title} href={action.href}>
                  ...
                  >
                    ...
                    <p className="text-sm text-primary-500 mt-1">{action.description}</p>
                    <div className="mt-4 flex items-center gap-2 text-primary-400 group-hover:text-accent-500 transition-colors">
          ...
          <motion.div variants={itemVariants}>
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-primary-900">Templates Recentes</h2>
              <Link href="/templates">
            ...
            {recentTemplates.length === 0 ? (
              <Card variant="bordered" className="p-8 text-center">
                ...
                <h3 className="text-lg font-medium text-primary-900">Nenhum template</h3>
                <p className="text-sm text-primary-500 mt-1 mb-4">
          ...
          {/* Workflow Guide */}
          <motion.div variants={itemVariants}>
            <Card variant="elevated" className="p-6 bg-gradient-to-br from-primary-900 to-primary-800">
